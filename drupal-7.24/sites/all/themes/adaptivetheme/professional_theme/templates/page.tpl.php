...
<div id="wrapper">
  ...
  $slide2_img= check_plain(theme_get_setting('slide2_image_url','professional_theme'));
  ...
  $slide3_img= check_plain(theme_get_setting('slide3_image_url','professional_theme'));
